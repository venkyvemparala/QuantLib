...
int main(int, char* []) {
    ...
    try {
        ...
        Rate riskFreeRate = 0.006;
        Volatility volatility = 0.20;
        Date maturity(17, May, 1999);
        DayCounter dayCounter = Actual365Fixed();

		// a rate curve
		Real zero_curve_rates_array[11] = { 
											0,
											0.00319884,
											0.00349082,
											0.00380623,
		...
		std::vector<Real> zero_curve_rates(zero_curve_rates_array,zero_curve_rates_array+11);	
		Date zero_curve_dates_array[11] = {
											Date(15,(QuantLib::Month)5,1998),
											Date(16,(QuantLib::Month)5,1998),
											Date(15,(QuantLib::Month)7,1998),
											Date(23,(QuantLib::Month)9,1998),
											Date(23,(QuantLib::Month)10,1998),
											Date(27,(QuantLib::Month)11,1998),
											Date(25,(QuantLib::Month)12,1998),
											Date(22,(QuantLib::Month)1,1999),
											Date(27,(QuantLib::Month)2,1999),
											Date(21,(QuantLib::Month)4,1999),
											Date(28,(QuantLib::Month)7,1999)
										};
		std::vector<Date> zero_curve_dates(zero_curve_dates_array,zero_curve_dates_array+11);
		QuantLib::Handle<QuantLib::YieldTermStructure> zeroCurve = Handle<YieldTermStructure>(boost::shared_ptr<YieldTermStructure>(new InterpolatedZeroCurve<Linear>(zero_curve_dates, zero_curve_rates,dayCounter)));
		...
		method = "Gen. Binomial Cox-Ross-Rubinstein";
		boost::shared_ptr<BlackScholesMertonProcess> bsmProcessGeneral(
                 new BlackScholesMertonProcess(underlyingH, flatDividendTS,
                                               zeroCurve, flatVolTS));
        europeanOption.setPricingEngine(boost::shared_ptr<PricingEngine>(
                      new GeneralizedBinomialVanillaEngine<GeneralizedCoxRossRubinstein>(bsmProcessGeneral,
                                                                   timeSteps)));
        bermudanOption.setPricingEngine(boost::shared_ptr<PricingEngine>(
                      new GeneralizedBinomialVanillaEngine<GeneralizedCoxRossRubinstein>(bsmProcessGeneral,
                                                                   timeSteps)));
